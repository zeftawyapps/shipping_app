...
final List<Order> sampleOrders = [
  Order(
    ...
    items: [
      OrderItem(
        name: "وجبة دجاج مشوي",
        description: "دجاج مشوي مع الأرز والسلطة",
        quantity: 1,
        unitPrice: 100.00,
        weight: 0.8,
      ),
      ...
      OrderItem(
        name: "سلطة خضراء",
        description: "سلطة طازجة مع الخضروات",
        quantity: 1,
        unitPrice: 10.00,
        weight: 0.2,
      ),
 ...
 id: "order_003",
    ...
    recipientDetails: ContactDetails(
      ...
      latitude: 30.7800,
      longitude: 31.0100,
      notes: "Third floor, apartment 305",
    ),
    items: [
      OrderItem(
        name: "وجبة سمك مقلي",
        description: "سمك مقلي مع البطاطس",
        quantity: 1,
        unitPrice: 120.00,
        weight: 0.9,
      ),
  ...
  Order(
    ...
    recipientDetails: ContactDetails(
      ...
      address: "الرياض، المملكة العربية السعودية - حي المرسلات، شارع العروبة",
      latitude: 30.8200,
      longitude: 30.9800,
      notes: "Apartment building, second floor",
    ),
    items: [
      OrderItem(
        name: "كيك شوكولاتة",
